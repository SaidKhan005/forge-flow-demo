...
`202605131020_admin_hierarchy_lifecycle_access_hardening.sql`. This
...
Pending follow-up scope (37 migrations; staging status varies, Production1 pending):
...
- Any migration outside the cutoff range above (anything with a lex prefix
  ...
  anything later than `202605131020_admin_hierarchy_lifecycle_access_hardening.sql`
