...
`202605131030_b11_1_auth_handoff_codes.sql`. This
...
Pending follow-up scope (38 migrations; staging status varies, Production1 pending):
...
- Any migration outside the cutoff range above (anything with a lex prefix
  ...
  anything later than `202605131030_b11_1_auth_handoff_codes.sql`
