...
| Partner gating | Unknown â€” some POS vendors require partnership applications |
...
| Backfill window limits | Unknown â€” app needs at least 60 days of closed-shift history |
...
| Sales | Expected â€” core POS field |
| Covers / guest count | Unknown â€” availability varies by vendor and tier |
| Checks / tickets | Unknown / pending vendor selection |
| Voids / comps | Unknown â€” may not be exposed by all vendors |
...
| Fallback close policy needed | Likely â€” app already has a close-policy evaluation path |
...
Key finding: Toast is the strongest POS candidate for the manager-live
Shift use case â€” it is the only candidate with confirmed guest-count
(`numberOfGuests`) availability and the richest order timestamps for
app-owned service-period bucketing.
