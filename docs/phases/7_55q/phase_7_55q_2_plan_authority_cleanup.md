...
| `docs/phases/7_55q/phase_7_55q_2_plan_authority_cleanup.md` | **New** — this doc; updated by the review-fix to honestly describe the read-only vs auto-generate split. |
