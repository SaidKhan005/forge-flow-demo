...
`202605131020_admin_hierarchy_lifecycle_access_hardening.sql`, including the later cron
maintenance, KMS flag seed, PII erasure, retention sweep, admin hierarchy
lifecycle, scoped Data Accuracy/Polling, lifecycle access hardening, and audit-log
