...
(Per-Daypart V1 R7a per-period covers-source hierarchy view +
scoped-overrides re-key; additive, existing outputs unchanged, hard
column drop deferred to follow-up R7d), including the later cron
