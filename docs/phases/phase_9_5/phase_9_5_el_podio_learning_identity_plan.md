...
Updated: 2026-05-03
Status: Active. `9.5.0` Postgres leaderboard schema + RLS skeleton accepted 2026-05-03 (migration `db/migrations/202605030000_phase_9_5_0_leaderboard_schema_rls.sql`; repository `lib/infrastructure/persistence/postgres/repositories/leaderboard_score_repository.dart`; walkthrough `docs/archive/_walkthroughs/9.5.0.md`). UX (`9.5.UX.*` family) and Recognition/Operations El Podio pulls remain queued.
