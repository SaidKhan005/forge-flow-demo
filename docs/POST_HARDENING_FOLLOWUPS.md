...
**18 migrations pending Production1/staging apply** (chronological):
...
**Action:** apply all 18 in next Production1 event per `runbooks/phase_9_production1_migration_apply_runbook.md`. Until applied + verified, the corresponding feature is **staging-ready only**.
