...
**45 migrations pending Production1 apply** (chronological). The queue now
runs through `202605131800_c_7a_recovery_codes_viewed_at.sql`; staging/preview
...
**Action:** apply all 45 in next Production1 event per
