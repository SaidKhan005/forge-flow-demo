...
- `7.55k` may add evidence-backed daypart depth
...
- `7.55k`: Evidence-backed daypart depth for History benchmark dayparts
...
- `7.55k`: Evidence-backed coaching and repeatable wins depth
...
- Should add TargetCycle and WeeklyPlanSnapshot columns when those models exist
- Should expose cycle identity and weekly plan identity
...
|-------------------|----------------|--------------|
| `TargetCycle` | Not implemented | `7.55l.1`–`7.55l.2` |
| `ActiveTargetProfile` as cycle projection | Exists but reads from BaselineData bridge | `7.55l.4` |
| `DemandForecastContext` v2 (baseline + 3-week trend) | v1 exists (baseline only) | `7.55l.5` |
| `WeeklyPlanSnapshot` | Not implemented | `7.55l.6` |
| Consumer migration (Schedule, Shift, Variance, History) | Not done | `7.55l.7` |
| Learn bridge retirement | **Complete (7.55l.8a–8d1)** — production runtime uses persisted cycle/profile/summary | `7.55l.8` |
| App-owned service-period definitions | Direction confirmed, not implemented | `7.55k` |
