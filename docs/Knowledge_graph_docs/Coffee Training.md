...
Medium dark roast coffee is crafted by cooking the beans at lower temperatures for extended periods, achieving a remarkable balance that makes it versatile for all brewing machines and grinders. This roasting technique ensures that the beans develop a rich profile, bringing out the inherent sugars while avoiding excessive oiliness, resulting in a darker roast that captivates the palate. Flavor notes often include delightful hints of dark chocolate, floral undertones, and nuances of hazelnuts. This roast is particularly well-suited for espresso extraction due to its balanced taste and ability to create the perfect texture and velvety crema.

Dark roast coffee is characterized by its deep, robust flavor profile, achieved through a meticulous roasting process that elevates the oils within the beans to the surface. This technique enhances the depth of flavor, bringing forth rich notes of smoke and caramel. While many coffee aficionados appreciate the boldness and complexity of dark roast, it does come with a caveat: the high oil content can lead to potential buildup in brewing equipment, necessitating diligent maintenance to ensure optimal performance.
...
- **No Steam Pressure:** If the machine is experiencing a high workload the water pressure may drop. If you lose steam pressure you will need to wait for several minutes for the machine to refill and for the water to reach optimum temperature.
...
- **DRIP TRAY AND RACK:** Periodically, you should also remove the drip tray and rack, rinsing them before wiping clean with a soft cloth.
- **GROUP HEAD BACK FLUSHING:** This simple yet effective maintenance procedure not only keeps your machine in top shape but also enhances the quality of your espresso extraction. Begin by scrubbing the group head with a clean brush to eliminate any coffee residue that may impede performance. Next, remove the filter basket from the espresso handle and replace it with a blind disk, which allows for proper backflushing. Insert the handle back into the group head and initiate the water flow; after about five seconds, halt the flow and rinse the blind disk thoroughly. Repeat this process several times until no coffee grounds are visible.
- **GROUP HEAD BACK FLUSHING WITH HEAD CLEAN SHAMPOO:** Every few days, you should perform a thorough backflush with this shampoo. Begin by scrubbing the group head with a dedicated head clean brush to eliminate any lingering coffee grind residues. Next, place a quarter teaspoon of head clean shampoo into your blank or blind disk and insert the filter handle into the coffee machine as if preparing to brew. Activate the water flow and count to ten, repeating this three times; you should notice white froth emerging from the exhaust tube, a sign that the cleaning process is effective. Finally, run the continuous flow button until no further froth is visible. It's important to repeat this entire procedure for each group head, ensuring optimal maintenance every second day to uphold the quality of your espresso.
- **GRINDER CLEANING AND MAINTENANCE:** Several times each week, at the end of the day, it's important to turn off the grinder, shut off the bean flow, and empty the hopper of any remaining beans. Be sure to clean the grinder thoroughly by wiping it down and removing any leftover ground coffee from the doser. A soft cloth or brush can help you clear away any loose grinds, ensuring your equipment stays in top shape for optimal performance.
...
Image captions on the cup-reference page:
...
- **AEROPRESS:** a manual, portable coffee maker that brews a smooth, rich cup in under two minutes.
- **ARABICA:** The world's most widely consumed coffee species accounts for approximately 60% of global production. Grown in elevated, mountainous regions, it is renowned for its smooth, naturally sweet taste and intricate flavor profile, which often includes delightful hints of fruit, floral notes, and rich chocolate undertones.
- **BACK FLUSHING:** This advanced deep-cleaning technique for espresso machines involves pushing hot water - and often a detergent - backward through the group head and out of the release valve. This effective process helps dissolve accumulated coffee oils and grounds, thereby preventing clogs and ensuring that your espresso maintains its rich flavors without any unpleasant rancidity.
- **BASKET:** A perforated metal filter designed specifically for holding your ground coffee. This essential component easily snaps into the portafilter handle and seamlessly fits into the espresso machine's group head. Once in place, hot water is forcefully channeled through the filter at high pressure, expertly extracting a rich and flavorful shot of espresso.
- **BLIND FILTER:** A solid filter basket that effectively cleans the internal group head and valves of your espresso machine. This seamless, hole-less design prevents water from flowing through, directing hot water and cleaning powder back through the machine's pressure-release valve. As a result, it efficiently dissolves accumulated coffee oils and grounds.
- **CHERRY:** The naturally occurring fruit of the coffee plant.
- **CREMA:** The golden-brown foam on top of an espresso.
- **DEMI-TASSE SPOON:** A miniature spoon traditionally used to stir espresso in small cups.
- **DOSER:** A mechanical, pie-compartmented chamber attached to the front of a coffee grinder.
- **DOSING CHAMBER:** A collection container located in front of the grinding burrs that holds ground coffee and dispenses it in pre-measured portions.
- **DOSING LEVER:** The mechanical handle on a traditional, commercial-style coffee grinder.
- **DRIP COFFEE:** This process involves gradually pouring hot water over ground coffee contained in a filter. As the water permeates the coffee grounds, gravity facilitates the extraction, allowing the infused coffee to drip down into a pot or mug below.
- **DRIP GRIND:** A medium grind size that resembles standard granulated sugar or rough sand.
- **DRIP TRAY:** Positioned beneath the brewing spout, it effectively collects any spilled coffee, drips during the brewing process, and excess water released during the machine's automatic rinse cycles. Generally adorned with a removable metal or plastic grate, this handy feature not only helps maintain a tidy countertop but also provides a stable surface for your cups.
- **ESPRESSO GRIND:** A very fine grind of coffee, similar in texture to table salt or powdered sugar.
- **FILTER:** A porous barrier used in coffee brewing to separate liquid coffee from ground beans.
- **FRENCH PRESS:** A manual coffee brewing device that consists of a cylindrical glass or metal carafe, a plunger, and a fine mesh filter. You brew coffee by steeping coarse grounds directly in hot water, then pressing the plunger down to separate the grounds from the finished, full-bodied coffee.
- **GRINDER:** A device designed to crush or cut whole coffee beans into smaller particles. By increasing the surface area of the beans, it allows hot water to effectively extract their rich flavors, aromatic oils, and enticing aromas during the brewing process.
- **GROUP HANDLE:** Also known as a portafilter, it is the removable, handled device on an espresso machine that holds the ground coffee.
- **GROUP HEAD:** The essential element of an espresso machine where it interfaces with ground coffee. Acting like a sophisticated water spout, it firmly locks the portafilter in place and ensures an even distribution of hot, pressurized water, thereby allowing for the precise extraction of rich espresso flavors.
- **HEAD CLEAN SHAMPOO:** A specialized chemical powder or tablet formulated to effectively dissolve bitter coffee oils and eliminate the buildup of residue from your espresso machine's brew head.
- **HOPPER:** The container on top of an espresso grinder that holds whole coffee beans before they are ground.
- **INSTANT COFFEE:** A convenient beverage crafted from real brewed coffee beans, which have been expertly dehydrated into a soluble powder or crystalline form. With a simple addition of hot or cold water or milk, these granules dissolve effortlessly, providing a quick
- **KNOCK BOX:** A specialized container used to cleanly and quickly dispose of spent espresso grounds from a portafilter.
- **PERCULATED:** Coffee brewed by continuously cycling boiling or near-boiling water through coffee grounds using the force of gravity. In contrast to standard drip machines, which allow water to pass through the grounds only once, a percolator recirculates the brewed coffee over the beans multiple times. This unique process results in a distinctively rich, robust flavor that can sometimes have a pleasantly bitter edge.
- **POUR OVER:** A manual brewing method where hot water is slowly poured over a bed of coffee grounds in a filter. Gravity pulls the water through the coffee and filter into a mug or carafe. This process highlights delicate flavour notes.
- **PURGE:** Releasing a brief burst of steam both before and after frothing from the steam wand. This simple step helps to eliminate trapped condensation and remove any milk residue from the wand, keeping your equipment free of clogs and ensuring consistently excellent results.
- **ROBUSTA:** A robust and high-yielding coffee species, this remarkable variety contributes to approximately 40% of global coffee production. Renowned for its bold, earthy flavor profile and rich crema, it also boasts nearly double the caffeine content of Arabica coffee, making it a popular choice among enthusiasts seeking an energizing brew.
- **STEAM ARM:** A metal pipe attached to an espresso machine that releases pressurized steam.
- **STEAM KNOB:** A physical dial on an espresso machine that controls the valve for the steam wand.
- **STEAM VALVE:** A specialized mechanical device designed to regulate, control, or isolate the flow of steam within a system.
- **STRETCHING:** The barista technique of introducing air into cold milk using an espresso machine's steam wand to create microfoam.
- **TAMP MAT:** A durable, non-slip silicone or rubber mat used in espresso preparation.
- **TAMPER:** A handheld, flat-based tool used to compress and level ground coffee into a dense, even puck inside an espresso machine's portafilter.
- **TEXTURE:** Milk that has been steamed and aerated using an espresso machine's steam wand to create microfoam.
- **WHOLE BEAN:** Roasted coffee beans left in their natural, full form before being ground.
