...
- Current next steps:
  ...
  - complete: `7.55m.0` runtime truth + surface cleanup planning / handoff
  - complete: `7.55m.1` / `7.55m.1a` shared date/business-date authority seam + day-order source unification
  ...
  - next: `7.55k.3` daypart pattern summary model
  - then: `7.55k.4` through `7.55k.8` downstream daypart, History, Learn, and Variance semantics hardening
...
- mock replay drift contract and lock-vs-drift rules
- replay-stable locked artifacts vs replay-regenerated scenario data contract
