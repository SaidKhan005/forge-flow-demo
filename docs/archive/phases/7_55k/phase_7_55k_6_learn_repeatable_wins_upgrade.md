# Phase 7.55k.6 â€” Learn Repeatable Wins Upgrade
...
scoped to the top-ranked win via a `COACHING â€” <label>` header. This prevents
...
- `docs/archive/phases/7_55k/phase_7_55k_6_learn_repeatable_wins_upgrade.md` (this doc)
...
- `docs/archive/phases/7_55k/phase_7_55k_5_history_benchmark_dayparts_upgrade.md` â€” History upgrade pattern
