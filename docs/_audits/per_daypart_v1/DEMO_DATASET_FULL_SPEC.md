...
- **Predecessor spec + slice audits:** `docs/_audits/per_daypart_v1/full_demo_data_spec.md`, `demo_slice_{a,b,c,d,e,f}_*.md`, `architecture_verification_2026_05_15.md`, `docs/_audits/per_daypart_v1/landed/fix_qa_perloc_current_week_open_shift.md`, `docs/_audits/per_daypart_v1/landed/fix_qa_location_scope_not_propagated.md`
