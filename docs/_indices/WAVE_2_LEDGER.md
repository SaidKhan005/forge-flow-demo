...
| OW-4 | Locations tab scope-conditional visibility — hide the operator-web "Locations" tab when the operator is at location scope (Business-level scope still shows the full hierarchy CRUD path) | Main | operator | merged | #730 | – | debug.md:141-143 (OW-4); shipped 2026-05-14 via PR #730 (commit `96f62973`) |
| AC-1 | Admin actor / actor_kind label sweep — replace machine-flavored `actor_kind` enum values on admin audit-log surfaces with the human-readable labels already centralized in `lib/admin/admin_human_labels.dart` | Main | operator | merged | #728 | – | debug.md:71-72 (AC-1); shipped 2026-05-14 via PR #728 (commit `55bcdcc4`) |
...
| RP-9 | Permission key `team.roles.default_catalog.edit` — gate the admin Default Role Catalog edit/publish surface on a dedicated permission key (was previously protected only by the broader admin guard) | Main | operator | merged | #731 | R-2L | debug.md:33-34 (RP-9); shipped 2026-05-14 via PR #731 (commit `cdd49ade`) |
| RP-10 | Invite member dialog — replace flat location dropdown with hierarchy-tree picker on operator-web + admin invite paths | Main | operator | merged | #732 | R-1L | debug.md:35 (RP-10); shipped 2026-05-14 via PR #732 (commit `72c99369`) |
| RP-15 | Benchmark override — manager-once cap + admin-undo UX on operator-web + admin (mobile surface confirmed absent and not in scope) | Main | operator | merged | #733 | – | debug.md:41 (RP-15); shipped 2026-05-14 via PR #733 (commit `0dbe4510`) |
