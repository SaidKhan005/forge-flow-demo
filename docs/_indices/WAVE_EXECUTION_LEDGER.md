...
| B9.2 | B9.2 | Codex | Medium | Medium | operator | B9.1 merged | audit-pending | #547 | My Account consolidation + Active Sessions — 4-card IA (Profile/Security/MFA/Active Sessions); existing routes only; client-side MFA freshness gate (server-side step-up deferred to B11.2). 34/34 tests pass; dart analyze clean. Audit doc: `docs/_audits/post_codex_wave/pr_547_b9_2_my_account_active_sessions_audit.md` |
