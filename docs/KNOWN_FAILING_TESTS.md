...
| `test/operator_web/screens/roles_screen_test.dart` | "renders advisory warning when team.users.invite is selected without team.users.view" — references the long-removed `operator_web_custom_role_editor_role_key` field. Pre-existing on master, reproduced WITHOUT current-slice changes. Disclosed by Wave 2 R-1L (PR #699), U-FU-tier-email (PR #713), and Q-4 (PR #716). | 2026-05-14 (Wave 2 closeout) | follow-up — re-pin the test against the current custom role editor surface (the `role_key` field was removed in U-5 PR #670 via the slugifier rewrite) |
