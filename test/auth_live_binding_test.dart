...
void main() {
  ...
  group('FirebaseAuthLoginService (B4)', () {
    ...
    test('signInWithEmailPassword Failed -> AuthLoginFailure preserves '
        'canonical code + message', () async {
      final client = _FakeFirebaseAuthClient(
    ...
    test(
      'Firebase invalid-credential maps to safe invalid_credentials code',
      () async {
        final client = _FakeFirebaseAuthClient(
          nextSignInOutcome: const FirebaseAuthSignInFailed(
