...
void main() {
  ...
  testWidgets('renders three tabs with the dependencies strip',
      (tester) async {
    ...
    expect(
      find.byKey(const Key('admin_health_tab_retrieval')),
      findsOneWidget,
    );
    ...
    expect(
      find.byKey(const Key('admin_health_dependencies')),
      findsOneWidget,
    );
    ...
    expect(
      find.byKey(const Key('admin_health_tier1_banner')),
      findsNothing,
    );
    expect(
