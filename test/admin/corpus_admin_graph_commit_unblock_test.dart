...
void main() {
    ...
    return GraphCandidateDiff(
      ...
      extracted: <GraphCandidate>[
        GraphCandidate(
          ...
          candidateKey:
              'graphify:edge:fixture_doc:section:contains',
  ...
  testWidgets(
    'commit button enables once the picker resolves a (operator, '
    ...
    (tester) async {
      ...
      expect(
        commitWidget.onPressed,
        isNotNull,
        reason: 'commit must enable once the picker resolves a pair '
