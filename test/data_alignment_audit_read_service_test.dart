...
void main() {
  ...
  // ── Per-Daypart V1 / Slice 6 (full scope) — 5 missing per-period ───────
  //
  // Plan Slice 6 categories 1-5 + the _planRuntimeChecks authority fix.
  // Each category: synthetic aligned → all PASS; deliberate per-period
  // mismatch → that category drifts with a clear message; absent
  // per-period data → honest "no per-period rows" state (not a false
  // PASS, not a hard FAIL, no fabricated 0).
