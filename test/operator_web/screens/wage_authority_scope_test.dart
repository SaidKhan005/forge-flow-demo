...
void main() {
  ...
  testWidgets(
      'inherited Business rate renders the "Inherited from the whole '
  ...
  testWidgets('location-owned rate renders "Set at this location"',
    ...
    expect(
      find.descendant(
        of: badge,
        matching: find.text('Set at this location'),
      ),
      findsOneWidget,
    );
  });
  ...
  testWidgets(
      'no hierarchy → degrades to Location notice, no misleading '
