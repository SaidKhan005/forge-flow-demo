...
void main() {
  ...
  ServicePeriodDefinition _servicePeriodDefinition({
    required String id,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        final configuredPeriods = <ServicePeriodDefinition>[
          _servicePeriodDefinition(id: 'lunch', label: 'Lunch', sortOrder: 1),
          _servicePeriodDefinition(id: 'brunch', label: 'Brunch', sortOrder: 2),
        ];
