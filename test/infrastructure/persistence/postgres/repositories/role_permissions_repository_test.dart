...
void main() {
  ...
  group('RolePermissionsRepository.upsertCell — permission_key catalog '
    ...
    test(
      'all 101 catalog keys round-trip — the repo never rejects a '
      ...
      () async {
        ...
        // 101 keys; the repo never gates on this — it only round-trips.
        expect(
          PermissionKeys.all.length,
          equals(101),
          reason: 'auth_permission_key_catalog.md contract calls out 101 '
              'keys total (81 baseline + 14 team.* + 3 admin + 1 '
              'integrations.configure + 2 B5.b settings keys); a count '
