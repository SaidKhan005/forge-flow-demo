...
Write-Host ''
Write-Host '4. Record connection strings into your local non-repo env file:'
Write-Host '     $HOME\.forge_flow.staging.ps1'
Write-Host '     POSTGRES_URL          - application-role connection string'
Write-Host '     POSTGRES_ADMIN_URL    - deployment-role connection string'
Write-Host ''
Write-Host '5. Source the env names into your shell:'
Write-Host '     $env:FORGE_FLOW_STAGING_ENV_FILE = "$HOME\.forge_flow.staging.ps1"'
...
Write-Host '   through 202604250005_advisor_cloud_foundation.sql.'
