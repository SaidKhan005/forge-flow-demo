...
| `8.business-scope-selector` | MERGED 2026-05-07 via PR #236 — Doc 1 Phase 1 location-level mobile scope foundation now has accessible-scope proxy routes, mobile model, local active-scope cache, hamburger drawer, sync cancellation/rebase, and cross-scope cache wipe proof. Group/region/company rollup dashboards remain future until server rollup truth exists. | `docs/contracts/mobile_core_business_scope_contract.md`, `docs/_execution/2026-05-07_mobile_business_scope_selector_proof.md` |
| `audit.admin-web-setting-sync` | ACCEPT 2026-05-07 — Doc 1 admin/web mobile-facing setting inventory found timing, data accuracy, keyed service-period settings, wage roles, polling assignments, target/profile truth, weekly plans/forecast context, and location-scope access all have server-owned mobile read routes or accepted cache mirrors. Remaining issues are console write parity or group/region/company rollup truth, not mobile source-of-truth gaps. | `docs/_execution/2026-05-07_admin_web_setting_sync_inventory.md` |
