...
//
// Source: docs/Knowledge_graph_docs/Push Employee SOP.md
...
const BarrioTrainingDoc kTrainingPushSop = BarrioTrainingDoc(
  id: 'training_push_sop',
  title: 'Push Schedule',
  sourcePath: 'docs/Knowledge_graph_docs/Push Employee SOP.md',
  chapters: [
    HandbookChapter(
      id: 'training_push_sop_c0',
      title: 'Schedule and Availability',
      subtitle: '6 cards',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_push_sop_c0_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'READ',
          title: 'My Schedule Screen',
          body: 'Opening the Push app lands you on the My Schedule screen. This '
              'shows the weekly Schedule you have been assigned.\n'
              '\n'
              'Date Range\n'
              '\n'
              'At the top on the grey bar you can choose the date range. Make '
              'sure you are looking at the correct date range for your '
              'schedule.\n'
              '\n'
              'Shift Tag\n'
              '\n'
              'Note the shift tag: This will show you the shift type. For '
              'example on call/until needed etc.\n'
              '\n'
              'Comments\n'
              '\n'
        ...
        HandbookUnit(
          ...
          badgeHint: 'READ',
          title: 'Side Menu',
          body: 'Clicking the burger icon on the top left opens up a side menu.\n'
              '\n'
              'Login Credentials\n'
              '\n'
              'This shows your login credentials: The 4 digit number here is '
              'what you use to clock in and out on the tablet downstairs in '
              'the staff area.',
          images: [
            HandbookUnitImage(
        ...
        HandbookUnit(
          id: 'training_push_sop_c0_u3',
          type: HandbookUnitType.explainer,
          badgeHint: 'READ',
          title: 'Availability: Weekly Tab',
          body: 'Under Availability the first tab is Weekly: This allows you to '
              'set when you are available to work.\n'
              '\n'
              'Available Check Box\n'
              '\n'
              'Note the Available check box. Clicking on this means you are '
              'available in this time period set. Left Unchecked means you '
              'are unavailable in that time period.\n'
              '\n'
              'Start and End Date\n'
              '\n'
