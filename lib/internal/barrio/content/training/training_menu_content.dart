...
//
// Source: docs/Knowledge_graph_docs/Barrio_Menu.md
...
const BarrioTrainingDoc kTrainingMenu = BarrioTrainingDoc(
  id: 'training_menu_concept',
  title: 'MENU',
  sourcePath: 'docs/Knowledge_graph_docs/Barrio_Menu.md',
  chapters: [
    HandbookChapter(
      id: 'training_menu_concept_c0',
      title: 'Dinner Menu',
      subtitle: '6 cards',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_menu_concept_c0_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'READ',
          title: 'Ceviches',
          body: 'Shrimp Cocktail - Lime Cured, Tomato, Mint, Salsa como '
              'Inglesa, Saltine Crackers\n'
              '\n'
              'Scallop Ceviche - Aji Amarillo, Cancha, Burnt Onion, Lava Salt\n'
              '\n'
        ...
        HandbookUnit(
          ...
          body: 'CHIPS GUAC AND SALSA\n'
              '\n'
              'Charred Jumbo Prawns - Chilli Paprika Butter, Pickled Onions, '
              'Cilantro\n'
              '\n'
              'Salad - 50/50 Cabbage Romaine, Sliced Beets, Tortilla Strips , '
              'Egg, Onion, Cilantro, Feta\n'
              '\n'
              'Marinated Mussels - Salsa Azafran ( saffron sauce), Paprika '
              'Chilli Oil, Garlic Crumb\n'
              '\n'
              'Sikil Pak (Pumpkin Seed Dip) - Chile, Tomato, Chives\n'
              '\n'
              'Empanadas (Deep Fried) 3pc - Beef Filling Served with Aji '
              'Sauce\n'
              '\n'
        ...
        HandbookUnit(
          ...
          badgeHint: 'READ',
          title: 'Anticucho',
          body: 'Pork Belly - Rococo Marinade, Pepper Chimichurri\n'
              '\n'
              'Beef Skewer - Aji Marinade, Corn, Chives, Lime Zest\n'
              '\n'
        ...
        HandbookUnit(
          ...
          badgeHint: 'READ',
          title: 'Mains',
          body: 'Pork Chop with Corn Husk Glaze\n'
              '\n'
              'Lomo Saltado - Potato, Peppers,Onion,Tomato\n'
              '\n'
              'Whole Fried Fish with 2 sides\n'
              '\n'
              'Pasta - Tallarines (tagliatelle noodle), Poblano Crema, Tajin, '
              'Queso Fresco\n'
              '\n'
              'Half Chicken - Ancho Marinade\n'
              '\n'
              'Steak - 20oz Rib Eye ,Chimichurri, Choice of two sides\n'
              '\n'
              'Fajitas - Choice of Chicken or Vegetarian Served with Shredded '
          ...
          images: [
            ...
            HandbookUnitImage(
              assetPath: 'assets/internal/barrio/training/training_menu_concept_photos/training_menu_concept_c0_u3_2.webp',
              caption: 'Photo: Dtarazona, CC BY-SA 3.0',
              afterParagraph: -1,
            ),
          ],
        ),
        HandbookUnit(
          id: 'training_menu_concept_c0_u4',
          type: HandbookUnitType.explainer,
          badgeHint: 'READ',
          title: 'Big Dish',
          body: 'Whole Fried Fish or Grilled Served with 2 sides\n'
              '\n'
              'Steak - 20oz Rib Eye ,Chimichurri, Choice of two sides\n'
              '\n'
              'Half Chicken - Ancho Marinade',
          images: [
            ...
            HandbookUnitImage(
              assetPath: 'assets/internal/barrio/training/training_menu_concept_photos/training_menu_concept_c0_u4_2.webp',
              caption: 'Photo: Ix kimiaranda, CC BY-SA 4.0',
              afterParagraph: -1,
            ),
          ],
        ),
        HandbookUnit(
          id: 'training_menu_concept_c0_u5',
          type: HandbookUnitType.explainer,
          badgeHint: 'READ',
          title: 'Sides',
          body: 'Street Corn\n'
      ...
      units: [
        ...
        HandbookUnit(
          ...
          body: '- CEVICHES\n'
              ...
              '- Scallop Ceviche\n'
              '\n'
              '- Scallop Ceviche - Aji Amarillo, Cancha, Burnt Onion, Lava '
              'Salt -> Peruvian Ceviche with Guatemalan Touch\n'
              '\n'
              '- -> Aji Amarillo =Yellow Chili Pepper, 30/50k Scoville Level: '
              'Member of the Genus Capsicum: Cornerstone of Peruvian Cuisine\n'
              '\n'
              '- -> Cancha = Premium Peruvian Snack. It\'s a Toasted Corn '
              'Kernel from Andean.\n'
              '\n'
        ...
        HandbookUnit(
          ...
          badgeHint: 'READ',
          title: 'Slide 6',
          body: '- CEVICHES · CONTINUED\n'
              '\n'
              '- Scallop Ceviche\n'
              '\n'
              '- -> Lava Salt = In Latin called Salnegra: This is an '
              'Ancestral Mayan Salt cooked for hours in clay pots over wood '
              'fire from Volcanic fed Saline Springs',
          images: [
            HandbookUnitImage(
        ...
        HandbookUnit(
          ...
          body: '- CEVICHES\n'
              ...
              '\n'
              '- Cod Aguachile - Red Onion, Cucumber, Jalapeño, Lime -> '
              'Mexican. Translates to Chili Water: Differs from Ceviche by '
    ...
    HandbookChapter(
      ...
      units: [
        HandbookUnit(
          ...
          body: '- MENU CONCEPT\n'
              '\n'
              '- Anticuchos (Shareables)\n'
              '\n'
              '- Charred Jumbo Prawns - Chilli Paprika Butter, Pickled '
              'Onions, Cilantro\n'
              '\n'
              '- Tacos 3 Per Order -> See Latin dishes to know for deeper '
              'dive into Al Pastor and Tinga\n'
              '\n'
              '- Al Pastor - Pork, Pineapple, Cilantro, Onion\n'
              '\n'
              '- Tinga - Chicken, Chipotle, Cilantro , Onion: Tinga ->\n'
              '\n'
        ...
        HandbookUnit(
          ...
          body: '- SHAREABLES\n'
              ...
              '\n'
              '- Sikil Pak (Pumpkin Seed Dip) - Chile, Tomato, Chives -> '
              'Sikil Pak means Pumpkin tomato: Mayan Hummus Substitute\n'
              '\n'
              '- Tetelas - Mushroom, Carrot. Mole, Crema? Find a substitute '
              'for the mole?\n'
              '\n'
              '- -> Made from Masa: Masa is Corn Dough; These are '
        ...
        HandbookUnit(
          ...
          body: '- SHAREABLES\n'
              ...
              '\n'
              '- Cactus: Mexican Cuisine is heavily influenced by the Nopal '
              'Cactus:\n'
              '\n'
              '- Fun Fact: The Aztec People, Early settlers of Mexico, Built '
              'Tenochtilian which is now Mexico City; The first Settlers saw '
              'an Eagle perched on a Nopal which is why there is a Nopal in '
              'the middle of the Mexican flag today.',
          images: [
            HandbookUnitImage(
              assetPath: 'assets/internal/barrio/training/barrio_legado_menu_concept_slides/08.webp',
              afterParagraph: 5,
            ),
          ],
        ),
      ...
      units: [
        ...
        HandbookUnit(
          ...
          body: '- MAINS\n'
              ...
              '- Lomo Saltado\n'
              '\n'
              '- Lomo Saltado is one of Peru\'s most iconic dishes and a '
              'defining example of Chifa cuisine the fusion of Chinese and '
              'Peruvian culinary traditions.\n'
              '\n'
              '- What is Chifa?\n'
              '\n'
              '- Chifa refers to the unique cuisine that developed when '
              'Cantonese immigrants introduced Chinese cooking techniques and '
              'ingredients to Peru, blending them with local Peruvian '
              'flavors.\n'
              '\n'
              '- Background\n'
              '\n'
              '- Lomo Saltado originated in Lima, Peru, during the late 19th '
              'and early 20th centuries. Cantonese immigrants from Guangdong '
              '(southern China) brought the wok, high-heat stir-frying, and '
              'ingredients such as soy sauce. These techniques were combined '
              'with Peruvian beef, onions, tomatoes, ají peppers, and native '
        ...
        HandbookUnit(
          ...
          body: '- MAINS\n'
              ...
              '\n'
              '- Pasta - Tallarines (tagliatelle noodle), Poblano Crema, '
              'Tajin, Queso Fresco\n'
              '\n'
              '- Tagliatelle noodle: Italian ribbon pasta; long and flat: '
              'made from sheets of fresh egg dough;\n'
              '\n'
              '- Tagliatelle translates to one precise ribbon\n'
              '\n'
              '- Fun fact: It comes from Emilia-Romagna, the region around '
        ...
        HandbookUnit(
          ...
          badgeHint: 'READ',
          title: 'Slide 14',
          body: '- MAINS · CONTINUED\n'
              '\n'
              '- Tallarines & Poblano Crema\n'
              '\n'
              '- Background: Tagliatelle crossed over to Latin America in '
              '1870-1930. In Spanish the name loosened to tallarines which is '
              'a general word for any long noodle, spaghetti, wok noodles, '
              'ribbon pasta.\n'
              '\n'
              '- Poblano Crema: Poblano Creamy Green Chile Sauce -> Burn skin '
        ...
        HandbookUnit(
          ...
          body: '- MAINS\n'
              ...
              '\n'
              '- Fun Fact: A swiss settler named Roger Scheler started '
              'roasting Chicken this way outside Lima Peru. A Swiss Engineer '
              'friend built him a rotating system. Locals quickly '
        ...
        HandbookUnit(
          ...
          body: '- MAINS\n'
              ...
              '- Steak - 20oz Rib Eye , Chimichurri, Choice of two sides\n'
              '\n'
              '- Chimichurri: Argentina\'s signature herb sauce, traditionally '
              'served with Asado (barbecue). Its flavor deepens as the '
              'ingredients meld over time.\n'
              '\n'
              '- Asado: The traditional open-fire grilling culture of '
              'Argentina\'s Pampas region.\n'
              '\n'
              '- Fun Fact: Asador means "grill master." An Asador\'s most '
              'valued skill is patience slowly tending the fire. Likewise, '
        ...
        HandbookUnit(
          ...
          body: '- MAINS\n'
              ...
              '- Fajitas & Sides\n'
              '\n'
              '- Fajitas - Choice of Chicken or Vegetarian Served with '
              'Shredded Cheese, 6 or 8 Tortillas\n'
              '\n'
              '- Sides\n'
              '\n'
              '- Street Corn\n'
      ...
      units: [
        HandbookUnit(
          ...
          body: '- SIDES\n'
              ...
              '- Gallo Pinto\n'
              '\n'
              '- Gallo Pinto The national breakfast of both Costa Rica and '
              'Nicaragua.\n'
              '\n'
