      ...
      units: [
        ...
        HandbookUnit(
          ...
          body: '1. Pull covers, sales, and labor hours from POS - by daypart. '
              '2. Calculate CPLH. Inside your OPZ? Above it or below it? 3. '
              'Calculate SPLH. Is BOH producing at target? Is PPA where you '
              'expected? 4. Compare to theoretical. What is the variance? 5. '
              'If CPLH inside OPZ, SPLH on target, variance tight -> '
              'benchmark shift. Write down what made it work. That is a '
              'replicable day. 6. If variance exists -> go to the lever cards '
              'in Chapter 10. Identify which input moved. Fix that specific '
              'thing. Not "labor." The input.\n'
              '\n'
