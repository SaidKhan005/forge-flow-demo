...
//
// Source: docs/Knowledge_graph_docs/GENERAL WORDS TO KNOW.md
...
const BarrioTrainingDoc kTrainingGeneralWords = BarrioTrainingDoc(
  id: 'training_general_words',
  title: 'General Words To Know',
  sourcePath: 'docs/Knowledge_graph_docs/GENERAL WORDS TO KNOW.md',
  chapters: [
    HandbookChapter(
      id: 'training_general_words_c0',
      title: '8 to C',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c0_u0',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'ALLERGY',
          body: 'Occurs when the body\'s immune system sees a certain food as '
              'harmful and reacts by triggering an allergic reaction. If '
        ...
        HandbookUnit(
          ...
          body: 'A comprehensive document utilized in the hospitality and '
              'events industry that outlines all critical details for an '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'BRAND',
          body: 'The unique identity of a company, which encompassing the '
              'names, logos, designs, symbols, and the emotions they evoke '
              'which serves as a critical differentiator in the marketplace. '
              'It not only shapes guest perceptions and expectations but also '
              'builds loyalty through a holistic guest experience that '
    ...
    HandbookChapter(
      id: 'training_general_words_c1',
      title: 'C to C',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c1_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'CHIT',
        ...
        HandbookUnit(
          ...
          body: 'Removing used dishes, cutlery, glasses, and any leftover food. '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'CORE VALUES',
          body: 'The fundamental, guiding beliefs and principles that define an '
              'organization\'s culture, shape its decisions, and direct '
              'employee behavior towards a shared mission, serving as an '
              'ethical compass that influences various aspects of operations, '
              'from hiring practices to guest interactions, ultimately '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'COURSE',
          body: 'An individual dish or a collection of dishes presented '
              'together as part of a well-organized meal. Courses are '
              'typically served in a sequential manner, often with a short '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'CULTURE',
          body: 'The shared personality of an organization, encompassing its '
              'core values, beliefs, attitudes, and behaviors that guide '
              'employee interactions and decision-making. It fundamentally '
              'shapes the daily workplace experience and influences overall '
              'business success by establishing both stated principles and '
    ...
    HandbookChapter(
      id: 'training_general_words_c2',
      title: 'D to F',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c2_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'DEPOSIT',
          body: 'The end-of-shift reconciliation process where servers and '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'DROWNING',
          body: 'The experience of being overwhelmed by a significant workload. '
              'This can arise from factors such as an excessive number of '
              'tables, delayed orders, or insufficient staff, which '
              'collectively hinder the ability to maintain efficient service. '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'FAMILY STYLE',
          body: 'A communal and casual dining atmosphere where large platters '
              'and bowls of various dishes are placed at the center of the '
              'table for sharing, rather than serving individual meals. This '
        ...
        HandbookUnit(
          ...
          body: 'A reminder acronym to how stock should be stocked, used, and '
              'rotated. Items that have been stored the longest (first in) '
    ...
    HandbookChapter(
      id: 'training_general_words_c3',
      title: 'G to M',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c3_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'GARNISH',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'GUEST',
          body: 'People coming to our restaurants are treated like our friends. '
              'We are welcoming them into our space and creating an '
        ...
        HandbookUnit(
          ...
          body: 'Also known as service recovery, is the intentional and '
              'systematic approach to rectifying errors and addressing guest '
              'complaints in order to transform a negative dining experience '
              'into a positive one; this process seeks to restore guest '
              'satisfaction, build trust, mitigate the risk of negative '
              'reviews, and promote repeat business by promptly identifying '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'HOSPITALITY',
          body: 'The art of delivering service that transcends mere '
              'functionality by fostering an emotional connection and a '
              'welcoming atmosphere; it involves not only anticipating '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'MARRY',
          body: 'Merging two partially filled bottles or containers of the same '
    ...
    HandbookChapter(
      id: 'training_general_words_c4',
      title: 'M to P',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c4_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'MDR',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'MISE EN PLACE',
          body: 'A French culinary phrase that translates to "everything in its '
              'place." It encompasses the essential practice of organizing '
              'and preparing all ingredients and components necessary for '
        ...
        HandbookUnit(
          ...
          body: 'A concise declaration of a company\'s fundamental purpose that '
              'explains why it exists, what it does, who it serves, and how '
        ...
        HandbookUnit(
          ...
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'MP (MARKET PLACE)',
          body: 'Price of an item based on its current cost in the market, '
        ...
        HandbookUnit(
          ...
          body: 'This metric serves as a valuable gauge of guest loyalty and '
              'the likelihood of guests recommending their dining experience '
              'to others. By surveying patrons, we categorize responses into '
              'three groups: Promoters (scores of 9-10), Passives (scores of '
              '7-8), and Detractors (scores of 0-6). The resulting score '
              'reflects overall guest satisfaction. The goal is to establish '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'PARTY CARD',
          body: 'When there are multiple servers all serving the same group, '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'PASS',
          body: 'The essential workspace where chefs showcase finished dishes '
              'for inspection, garnishing, and final handoff to servers. '
              'Acting as a crucial control checkpoint between the BOH and the '
              'FOH, this area is typically overseen by an expeditor or head '
              'chef. Various components from different stations are '
    ...
    HandbookChapter(
      id: 'training_general_words_c5',
      title: 'P to R',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c5_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'PATT',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'POLISH',
          body: 'The procedure of hand-drying and cleaning items right after '
              'washing is essential for eliminating water spots, streaks, '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'PRE-FIXE',
          body: 'French for "fixed price," refers to a thoughtfully curated '
              'multi-course meal available at a set cost. This dining option '
              'typically includes an appetizer, entree, and dessert, allowing '
              'guests to select from a limited menu for each course. This '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'REGULAR',
          body: 'A frequent visitor to a dining establishment, typically '
              'stopping by weekly or monthly, becoming a familiar face to the '
              'staff. Many regulars establish a routine, such as sitting in '
              'their favorite spots and ordering signature dishes. This '
        ...
        HandbookUnit(
          ...
          body: 'A form employers must issue when an employee experiences an '
    ...
    HandbookChapter(
      id: 'training_general_words_c6',
      title: 'S to T',
      subtitle: '12 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c6_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'SECTION',
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'SHARP',
          body: 'A vital safety alert to indicate that individuals are moving '
              'behind others while carrying knives or other sharp, hazardous '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'TABLE TURNS',
          body: 'The practice of efficiently serving guests and clearing tables '
              'to facilitate a prompt reset for new patrons thereby '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'TECH STACK',
          body: 'The comprehensive array of software, applications, and '
              'hardware that a restaurant employs to streamline its '
              'operations, serving as the digital backbone for essential '
              'functions such as point-of-sale transactions, inventory '
              'management, reservations, online ordering, marketing, and '
              'staff scheduling; in essence, it represents the modern '
    ...
    HandbookChapter(
      id: 'training_general_words_c7',
      title: 'T to W',
      subtitle: '8 terms',
      iconCodePoint: 0xe865,
      units: [
        HandbookUnit(
          id: 'training_general_words_c7_u0',
          type: HandbookUnitType.explainer,
          badgeHint: 'TERM',
          title: 'TEMPERATURE DANGER ZONE',
          body: 'The temperature range where bacteria multiply the quickest. '
              'This range is between 4 - 60 degrees Celsius or 40 - 140 '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'TIP POOL',
          body: 'A structured system in which employees merge all or part of '
              'their individual tips, distributing them among the team '
              'according to a predetermined formula. The intention behind '
        ...
        HandbookUnit(
          ...
          badgeHint: 'TERM',
          title: 'TURNOVER',
          body: 'The rate at which employees exit a business - whether through '
              'voluntary resignation or involuntary separation - must be '
              'replaced, usually measured as a percentage over a specific '
              'timeframe. This metric is particularly critical in the '
              'hospitality sector due to the significant costs, service '
