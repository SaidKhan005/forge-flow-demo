// Phase 11W.7 — Operator Web Account screen.
//
// V1 Account / Business setup surface. Four sections, all of them
// read-mostly at V1 per `project_v1_lean_scope_cut.md`:
//
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  //     2-column wrap.
  //   * standalone (widget tests rendering AccountScreen without the
