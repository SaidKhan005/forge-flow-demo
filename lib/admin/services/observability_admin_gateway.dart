...
const Map<String, Object?> kObservabilityAdminDemoEnvelope = <String, Object?>{
  ...
  'projection_retries': <String, Object?>{
    ...
    'recent_active': <Map<String, Object?>>[
      <String, Object?>{
        'job_id': 'active-retry-0001',
        'operator_id': '00000000-0000-4000-8000-000000000001',
        'location_id': '00000000-0000-4000-8000-0000000000a1',
        'original_location_id': '00000000-0000-4000-8000-0000000000a1',
        'restaurant_id': '00000000-0000-4000-8000-0000000000a1',
        'connection_id': '00000000-0000-4000-8000-0000000000c1',
        'original_connection_id': '00000000-0000-4000-8000-0000000000c1',
        'vendor_id': 'toast',
        'category': 'pos',
        'status': 'pending',
        ...
        'fact_count': 3,
        'attempt_count': 2,
        'changed_period_count': 1,
        'open_current_fact_count': 2,
        ...
        'last_error_message': 'projection writer unavailable',
        'stack_first_frame': '#0 demo',
      },
    ],
    'dead_lettered': <Map<String, Object?>>[
      <String, Object?>{
        'job_id': 'dead-retry-0001',
        'operator_id': '00000000-0000-4000-8000-000000000001',
        'location_id': '00000000-0000-4000-8000-0000000000a1',
        'original_location_id': '00000000-0000-4000-8000-0000000000a1',
        'restaurant_id': '00000000-0000-4000-8000-0000000000a1',
        'connection_id': '00000000-0000-4000-8000-0000000000c2',
        'original_connection_id': '00000000-0000-4000-8000-0000000000c2',
        'vendor_id': 'square',
        'category': 'pos',
        ...
        'fact_count': 1,
        'attempt_count': 5,
        'changed_period_count': 0,
        'open_current_fact_count': 1,
        ...
        'last_error_message': 'service period missing',
        'stack_first_frame': '#0 demo',
      },
    ],
    'limits': <String, Object?>{'recent_active': 25, 'dead_lettered': 25},
  },
