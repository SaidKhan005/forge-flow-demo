...
// the audit-log route then renders [AuditLogAdminScreen] without a
// `rootNode`, preserving the existing text-field scope fallback.
...
/// to the manual text-field scope inputs.
