...
class AdminSetupWorkspace extends StatefulWidget {
  const AdminSetupWorkspace({
    ...
    this.splitBreakpoint = _kDefaultWorkspaceSplitBreakpoint,
  ...
  /// Minimum shell-body width before the workspace renders scope and function
  /// side-by-side. Screens with dense right panes can opt into a wider
  /// breakpoint while preserving the shared scope tree.
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final workspaceWidth = constraints.hasBoundedWidth
            ...
            : shellBodyWidth;
        final compact = workspaceWidth < widget.splitBreakpoint;
