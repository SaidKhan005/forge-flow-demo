...
const List<StepUpRouteSpec> kStepUpSensitiveRoutes = <StepUpRouteSpec>[
  ...
  StepUpRouteSpec(
    ...
    maxAge: kStepUpDefaultFreshness,
    challengeTtl: kStepUpDefaultChallengeTtl,
    label: 'Editing plan pricing requires a fresh sign-in.',
  ),
  StepUpRouteSpec(
    method: 'PATCH',
    path: '/v1/admin/pricing/entitlements/',
    isPrefix: true,
    acr: kStepUpDefaultAcr,
    maxAge: kStepUpDefaultFreshness,
    challengeTtl: kStepUpDefaultChallengeTtl,
    label: 'Editing plan features requires a fresh sign-in.',
  ),
  StepUpRouteSpec(
    method: 'PUT',
    path: '/v1/admin/pricing/scoped-contracts',
    isPrefix: false,
    acr: kStepUpDefaultAcr,
    maxAge: kStepUpDefaultFreshness,
    challengeTtl: kStepUpDefaultChallengeTtl,
    label: 'Editing custom contracts requires a fresh sign-in.',
  ),
  StepUpRouteSpec(
    method: 'DELETE',
    path: '/v1/admin/pricing/scoped-contracts/',
